...
void OLED_Init(void)        
{
  ...
  //  D0_GPIO = (0|PORT_PCR_MUX(1));
  //  D1_GPIO = (0|PORT_PCR_MUX(1)); 
  //  RST_GPIO = (0|PORT_PCR_MUX(1));
  //  DC_GPIO = (0|PORT_PCR_MUX(1)); 
  //  
  //  //设置D0,D1,RST,DC为输出方向
  //  D0_DDR = D1_DDR = RST_DDR = DC_DDR = 1;  
...
void LCD_P16x16Str(u8 x,u8 y,u8 ch[])
{
  ...
  while(ch[ii] != '\0')
  {
    ...
    u8* ch_ptr;
    u32 ch_addr;
    ch_addr = 0x40000+(94*(ch[ii]-0xA1)+ch[ii+1]-0xA1)*32;
    ch_ptr = (u8*)ch_addr;
    LCD_Set_Pos(x , y);
    for(wm = 0;wm < 16;wm++)               
    {
...
//返回：无  
//============================================================== 
void LCD_P6x8Char(u8 x,u16 y,u8 ch)
{
    u8 c=0,i=0;     
...
//==============================================================
//函数名：   void LCD_PrintValueF(uchar x, uchar y, float data, uchar num);
